package com.example.restauranteapp.list_item
...
fun FoodItem(
    ...
    ConstraintLayout(
        ...
        Image(
            painter = painterResource(id = imagemFood!!),
            contentDescription = null,
            modifier = Modifier
                .constrainAs(ref = imgFood) {
        ...
        Text(
            ...
            color = Color.White,
            modifier = Modifier
                .constrainAs(ref = txtFoodDescription) {
